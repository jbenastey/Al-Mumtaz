            ...
            <ul class="nav navbar-top-links navbar-right" role="navigation">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li>
                            <a href="<?php echo base_url().'auth/logout'?>"  onclick="return confirm('Apakah anda yakin ingin keluar?')"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url().'log'?>"><i class="fa fa-qrcode"></i> Log Aktivitas</a>
                    </li>
                    <!-- <li>
                        <a href="#"><i class="fa fa-qrcode"></i> Data Master<span class="fa arrow"></span></a>
